...
logo=f"""______  _                       _       
  ...
  |  ____/|  _ \ / _ \| ___ |  _ \| ( \ / )
  | |     | | | | |_| | ____| | | | |) X ( 
  |_|     |_| |_|\___/|_____)_| |_|_(_/ \_)ðŸ™ƒðŸ« =========================="""
def logox():
    os.system('clear')
    print(logo)
...
def main():
    ...
    if want in ["A","a","1","01"]:
        ...
        print(cox)
        print("  [âœ“] Thanks Phoenix  For using My tool")
        print(cox)
        sys.exit()
    else:
        print(cox)
...
def auto_pass(fileeee):
    ...
    print(cox)
    print("  [âœ“] Id Save: /sdcard/PHOENIX.txt")
    print(cox)
...
def file_subb(uid,pwx):
    global oks,loop,cps
    sys.stdout.write(f"\r  \033[38;5;46m[PHOENIX] {loop}|{str(len(oks))}");sys.stdout.flush()
